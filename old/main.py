...
parser = argparse.ArgumentParser(
    description="Cluster Data for hdbscan, can use groupby"
)
parser.add_argument(
    "-f",
    "--file",
    type=str,
    required=True,
    help="path to file of input data, "
    "you can omit the path if u have the file in the same folder of the script",
)
parser.add_argument(
    "-ig",
    "--input-groupby",
    default=None,
    type=str,
    help="specify if you want to groupby the data before running hdbscan "
    "Eg '-ig ['col_name1', 'col_name2']'",
)
parser.add_argument(
    "-ic",
    "--input-columns",
    default=None,
    type=str,
    help="specify if you want to use only certain columns of the data into hdbscan "
    "Eg '-ic ['col_name1', 'col_name2']'",
)
...
if __name__ == "__main__":
    ...
    if yes:
        ...
        # change the stats you would like to see in stat_name
        # if they are part of pandas.core.groupby.GroupBy.*
